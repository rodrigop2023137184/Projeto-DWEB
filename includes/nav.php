...
<nav class="navbar navbar-expand-sm bg-primary navbar-dark">
    <div class="container-fluid">
        <a class="navbar-brand fw-bold text-light" href="Home.php">CRC</a>
        ...
        <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
            <div class="navbar-nav">
                <div class="nav-item">
                    <a class="nav-link <?php echo ($currentPage == 'Home.php') ? 'active' : ''; ?> fw-bold text-light" href="home.php">Home</a>
                </div>
                <div class="nav-item">
