...
-- A despejar dados para tabela crcdatabase.carrinho: ~4 rows (aproximadamente)
INSERT INTO `carrinho` (`id_carrinho`, `id_utilizador`, `id_produto`, `quantidade`, `tamanho_escolhido`, `preco_unitario`, `data_adicao`, `data_atualizacao`) VALUES
	...
	(7, 3, 2, 3, 'S', 25.00, '2026-01-15 18:15:39', '2026-01-15 18:29:43'),
	(8, 3, 2, 1, 'M', 25.00, '2026-01-15 18:29:22', '2026-01-15 18:29:22');
...
-- A despejar dados para tabela crcdatabase.encomenda: ~8 rows (aproximadamente)
INSERT INTO `encomenda` (`id_encomenda`, `id_utilizador`, `subtotal`, `taxa_envio`, `total`, `nome_destinatario`, `morada_envio`, `codigo_postal`, `cidade`, `telefone`, `metodo_pagamento`, `estado_pagamento`, `referencia_pagamento`, `data_pagamento`, `estado`, `numero_rastreio`, `notas_cliente`, `notas_internas`, `data_encomenda`, `data_atualizacao`) VALUES
	...
	(4, 8, 25.00, 5.00, 30.00, 'Carlos Silva', 'Rua 25 de abril', '3180-838', 'Coimbra', '969969696', 'cartao', 'pendente', NULL, NULL, 'pendente', NULL, '', NULL, '2026-01-20 19:34:50', '2026-01-20 19:34:50'),
	(5, 8, 25.00, 5.00, 30.00, 'Carlos Silva', 'Rua 25 de abril', '3180-838', 'Coimbra', '969969696', 'multibanco', 'pendente', 'Entidade: 12345 | Referência: 000000005', NULL, 'pendente', NULL, '', NULL, '2026-01-20 19:38:41', '2026-01-20 19:38:41'),
	(6, 8, 25.00, 5.00, 30.00, 'Carlos Silva', 'Rua 25 de abril', '3120-232', 'Coimbra', '969969696', 'mbway', 'pendente', 'MBWAY-6', NULL, 'pendente', NULL, '', NULL, '2026-01-20 19:43:13', '2026-01-20 19:43:13'),
	(7, 8, 25.00, 5.00, 30.00, 'Carlos Silva', 'Rua 25 de abril', '3180-838', 'Coimbra', '969969696', 'mbway', 'pendente', 'MBWAY-7', NULL, 'pendente', NULL, '', NULL, '2026-01-20 19:58:03', '2026-01-20 19:58:03'),
	(8, 8, 25.00, 5.00, 30.00, 'Carlos Silva', 'Rua 25 de abril', '3180-838', 'Coimbra', '969969696', 'mbway', 'pendente', 'MBWAY-8', NULL, 'pendente', NULL, '', NULL, '2026-01-20 19:59:50', '2026-01-20 19:59:50');
...
-- A despejar dados para tabela crcdatabase.encomenda_item: ~7 rows (aproximadamente)
INSERT INTO `encomenda_item` (`id_item`, `id_encomenda`, `id_produto`, `nome_produto`, `tamanho`, `quantidade`, `preco_unitario`, `subtotal`) VALUES
	...
	(4, 4, 2, 'T-shirt CRC Oficial Branca', 'L', 1, 25.00, 25.00),
	(5, 5, 2, 'T-shirt CRC Oficial Branca', 'XL', 1, 25.00, 25.00),
	(6, 6, 2, 'T-shirt CRC Oficial Branca', 'XL', 1, 25.00, 25.00),
	(7, 7, 1, 'T-shirt CRC Oficial Preta', 'XS', 1, 25.00, 25.00),
	(8, 8, 1, 'T-shirt CRC Oficial Preta', 'S', 1, 25.00, 25.00);
...
-- A despejar dados para tabela crcdatabase.inscricao_evento: ~8 rows (aproximadamente)
INSERT INTO `inscricao_evento` (`id_inscricao`, `id_evento`, `id_utilizador`, `distancia_escolhida`, `tamanho_tshirt`, `valor_pago`, `metodo_pagamento`, `estado_pagamento`, `referencia_pagamento`, `data_pagamento`, `numero_dorsal`, `status`, `observacoes`, `necessidades_especiais`, `data_inscricao`, `data_cancelamento`) VALUES
	...
	(7, 2, 8, '21km', 'L', 25.00, 'pendente', 'pendente', NULL, NULL, 4, 'ativa', NULL, NULL, '2026-01-20 18:19:41', NULL),
	(8, 1, 3, '5km', 'M', 15.00, 'pendente', 'pendente', NULL, NULL, 2, 'ativa', NULL, NULL, '2026-01-20 20:41:34', NULL);
...
INSERT INTO `produto` (`id_produto`, `nome`, `descricao`, `categoria`, `preco`, `imagem`, `stock_total`, `tem_tamanhos`, `tipo_tamanho`, `material`, `peso`, `slug`, `status`, `visivel`, `data_criacao`, `data_atualizacao`) VALUES
	(1, 'T-shirt CRC Oficial Preta', 'T-shirt técnica oficial do Coimbra Running Club. Tecido respirável e de secagem rápida, perfeita para treinos e corridas. Design moderno com logo do clube estampado.', 'roupa', 25.00, 'imgs/tshirtpretacrc.png', 78, 1, 'roupa', 'Poliéster técnico 100%', '150g', 'tshirt-crc-oficial-preta', 'ativo', 1, '2025-12-04 15:09:47', '2026-01-20 20:40:28'),
	(2, 'T-shirt CRC Oficial Branca', 'T-shirt técnica oficial do Coimbra Running Club. Tecido respirável e de secagem rápida, perfeita para treinos e corridas. Design moderno com logo do clube estampado.', 'roupa', 25.00, 'imgs/tshirtbrancacrc.png', 77, 1, 'roupa', 'Poliéster técnico 100%', '150g', 'tshirt-crc-oficial-branca', 'ativo', 1, '2025-12-04 15:09:47', '2026-01-20 19:43:13'),
	(3, 'T-shirt CRC Roxa', 'T-shirt técnica oficial do Coimbra Running Club. Tecido respirável e de secagem rápida, perfeita para treinos e corridas. Design moderno com logo do clube estampado.', 'roupa', 25.00, 'imgs/tshirtroxacrc.png', 79, 1, 'roupa', 'Poliéster técnico 100%', '150g', 'tshirt-crc-multicor', 'ativo', 1, '2025-12-04 15:09:47', '2026-01-19 20:14:31'),
...
-- A despejar dados para tabela crcdatabase.utilizador: ~4 rows (aproximadamente)
INSERT INTO `utilizador` (`id_utilizador`, `primeiro_nome`, `ultimo_nome`, `email`, `telefone`, `data_nascimento`, `genero`, `password_hash`, `data_registo`, `data_ultima_atualizacao`, `ativo`, `tipo`, `email_verificado`, `token_verificacao`, `token_recuperacao_password`, `data_expiracao_token`, `tentativas_login`, `bloqueado_ate`) VALUES
	...
	(3, 'Admin', 'Sistema', 'admin@crc.pt', NULL, '2025-12-10', NULL, '$2y$10$61GmsR9EDn79zrNFzHzY.eJI/SdmI8J5i3zW604FHtHTTLY5pUI7q', '2025-12-10 19:56:10', '2026-01-20 20:38:13', 1, 'admin', 1, NULL, NULL, NULL, 0, NULL),
	(8, 'Carlos', 'Silva', 'carlossilva@gmail.com', '969969696', '2005-10-20', 'outro', '$2y$10$jjCF6Q6HyO0lYI1yFQVbeelOr/txa.s5yM487oXf4udteYzf6R9Gq', '2026-01-20 18:04:27', '2026-01-20 20:39:36', 1, 'utilizador', 0, '295edfe4c3954e68f7903185259116be95dd8785997bbcb99b15307019320db2a00ed8756b48f97f8866aa6a87e9875e3411', NULL, NULL, 0, NULL);
